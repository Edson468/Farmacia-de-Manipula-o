// Define o componente HeroSection, a seção principal de destaque da página.
  ...
  return (
    <section
      ...
      style={{
        ...
        backgroundAttachment: 'fixed', // Cria um efeito sutil de parallax ao rolar a página.
      }}
    >
      {/* Camada de sobreposição escura para melhorar a legibilidade do texto sobre a imagem. */}
      ...
      <div className="container mx-auto px-4 text-center max-w-3xl relative z-10">
        ...
        {/* Botão de chamada para ação (CTA) que leva à seção de contato. */}
        <a
          href="#contato"
